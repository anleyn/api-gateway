...
const CONTROLLER_NAME = 'regTildaController'
...
// === СЕРВИСЫ ===
const regTildaService = require(`${PATH_SERVICES}/analytics/regTildaService.js`)
...
logger.debug(`Сервис regTildaService подключен из ${PATH_SERVICES}/visits/regTildaService.js`)
 ...
 */
module.exports.handleReg = async (request, response, requestId) => {
  ...
  try {
    ...
    const visitHeaders = request.headers
    await regTildaService.processReg(requestId, visitHeaders, visitData)
