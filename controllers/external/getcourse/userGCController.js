...
const CONTROLLER_NAME = 'userGCController'
...
// === СЕРВИСЫ ===
const userGCService = require(`${PATH_SERVICES}/services/userGCService.js`)
...
logger.debug(`Сервис userGCService подключен из ${PATH_SERVICES}/visits/userGCService.js`)
 ...
 */
module.exports.handle = async (request, response, requestId) => {
  ...
  try {
    ...
    await userGCService.processReg(requestId, visitHeaders, visitData)
