...
const ROUTER_NAME = 'utilsRouters'
...
// === КОНТРОЛЛЕРЫ ===
const expTimeController = require(`${PATH_CONTROLLER}/analytics/expTimeController.js`)
const expTimeControllerPath = CONFIG.controllers.expTimeController.path
