...
const ROUTER_NAME = 'visitsRouters'
...
// === КОНТРОЛЛЕРЫ ===
const visitTildaController = require(`${PATH_CONTROLLER}/analytics/visitTildaController.js`)
const visitTildaControllerPath = CONFIG.controllers.visitTildaController.path
